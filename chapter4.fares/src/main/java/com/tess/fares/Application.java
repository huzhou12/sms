...
import com.tess.fares.repository.FaresRepository;
...
public class Application implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		//Arrays.asList(fares).forEach(fare->faresRepository.save(fare));
		//faresRepository.save(list);
